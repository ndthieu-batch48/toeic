...
# def ask_gemini_with_image(prompt: str, image_base64: str) -> str:
#     # Decode base64 string to bytes
#     image_data = base64.b64decode(image_base64.split(",")[-1])  # loại bỏ "data:image/png;base64," nếu có
...
# def ask_gemini_with_image(prompt: str, media_id: int) -> str:
#     conn = connect()
...
#             # Chuyển URL thành đường dẫn file thực tế
